...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH, // 是否显示切换主题按钮
  ...
  GREETING_WORDS:
    ...
    'Welcome to my blog and we hope that we can become friends , Hi 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '璐🦌', // 您的昵称 例如 tangly1024
  BIO:
    process.env.NEXT_PUBLIC_BIO ||
    '尝试不同美食和当地特色的美食家🥗和程序媛一枚🖥️', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.whitelu.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '璐🦌, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL:
    process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'southmountainas@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Aurora-lulu', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || '', // 你的linkedIn 首页
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || '', // 您的instagram地址
  CONTACT_FACEBOOK:
    process.env.NEXT_PUBLIC_CONTACT_FACEBOOK ||
    'https://www.facebook.com/profile.php?id=100093638055944', // 您的facebook地址
  ...
  FIREWORKS_COLOR: ['255, 20, 97', '24, 255, 146', '0,0,205', '255,182,193'],
